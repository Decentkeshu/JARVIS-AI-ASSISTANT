...
export default function SignInPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-900 flex">
      ...
      {/* Left Panel — no border, same gray background */}
      <div className="min-h-screen flex" style={{ background: "#0a0a0a" }}>
       ...
       <div className="hidden lg:flex w-1/2 flex-col justify-between p-20 relative overflow-hidden" style={{ background: "#0a0a0a" }}>
        ...
        <div className="flex items-center gap-3 relative z-10">
          {/* <div className="w-10 h-10 rounded-2xl bg-gradient-to-br bg-green-700 flex items-center justify-center shadow-lg shadow-indigo-500/30"> */}
      ...
      {/* ✅ No divider line between panels */}

      {/* Right Panel — same gray background, wider */}
                ...
                <div className="flex gap-2">
                  {(["username", "email"] as const).map((method) => (
                    <button
                      ...
                      className={`px-5 py-2 rounded-full text-xs font-semibold border transition-all duration-200 capitalize ${loginwith === method ? "border-indigo-400 bg-indigo-500/10 text-indigo-300" : "border-gray-600 text-gray-500 hover:text-gray-300 hover:border-gray-400"}`}
                    >
                      {method}
                    </button>
                  ))}
